...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "fixed inset-y-0 left-0 z-50 w-64 bg-card border border-border shadow-sm transform transition-transform duration-300 ease-in-out lg:translate-x-0 m-6 rounded-lg",
          isMobileMenuOpen
            ? "translate-x-0"
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-center h-16 px-4 border-b border-border">
            <div className="flex items-center space-x-3">
              ...
              <h1 className="text-xl font-bold text-card-foreground">Origins</h1>
            </div>
          </div>
